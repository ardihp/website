...
function Header() {
  ...
  return (
    <div className="duration-300 sticky shadow-lg shadow-sky-200/25 top-0 border-b-2 border-dashed border-sky-200 rounded-b-xl">
      <div className="flex justify-between items-center bg-white/80 backdrop-blur-sm py-4 px-6 lg:px-24 duration-300">
        <Link href="/" passHref>
          ...
          {({ open }) => (
            <>
              ...
              <div className="absolute top-16 right-2 sm:relative sm:inline-block sm:top-0 w-48 sm:w-auto">
                ...
                >
                  <Menu.Items
                    className="flex flex-col items-center bg-white p-4 sm:p-0 border-2 sm:border-0 border-dashed border-sky-300/50 rounded-xl sm:flex-row space-y-4 sm:space-y-0 sm:space-x-6 divide-y sm:divide-y-0 sm:divide-x"
                    static
                  >

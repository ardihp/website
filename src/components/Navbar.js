        ...
        {({ open }) => (
          <>
            ...
            <div className="absolute top-16 right-2 sm:relative sm:inline-block sm:top-0 w-48 sm:w-auto">
              ...
              >
                <Menu.Items
                  className="flex flex-col items-center dark:bg-slate-900/90 dark:sm:bg-transparent bg-white/90 sm:bg-transparent p-4 sm:p-0 border-2 sm:border-0 border-dashed dark:border-slate-400 border-sky-300/50 rounded-xl sm:flex-row space-y-4 sm:space-y-0 sm:space-x-6 divide-y sm:divide-y-0 sm:divide-x"
                  static
                >

...
function ProjectCard({ title, description, image, url, source, stack }) {
  return (
    <div className="transform duration-300 hover:-translate-y-1">
      <div className="flex flex-col h-full border-2 p-3 border-dashed border-gray-300/30 rounded-lg bg-white/10 backdrop-blur-sm relative">
